...
parser.add_argument('--featuretype', '-t', help="Type of the features to use", type=str, default="C3D.npy")
...
parser.add_argument('--weights', '-w', help="Network weights to use for inference", type=str, default='last_weights_C3D_11_25.h5')
