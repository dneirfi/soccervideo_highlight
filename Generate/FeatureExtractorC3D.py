...
from Generate.FeatureExtractorBase import FeatureExtractorBase
...
class FeatureExtractorC3D(FeatureExtractorBase):
    def __init__(self):
        ...
        self.model = self.C3D_model(weights_path=cwd+"\weights_C3D_sports1M_tf.h5", summary=True)
        return
    ...
    def elaborateVideo(self, videoPath, game_start_time, game_end_time):
        ...
        #print(int(game_start_time * fps))
        #print(int((game_end_time + game_start_time)))
